        ...
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 place-items-end">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs font-bold text-(--muted)">
              GoalLine Turf is a premuim 5-a-side football turf designed to give
              you the best playing experience with top-quality facilties, a
              secure environment, and excellent customer service.
            </p>
            <p className="text-xs font-bold text-(--muted)">
              Whether you&apos;re here for a casual game with friends, a
              competitive match, or regular training session, we&apos;ve got the
