        ...
        <div className="w-[90%] mx-auto flex flex-col gap-8 md:grid md:grid-cols-2">
          <div className="flex flex-col gap-6 justify-center">
            ...
            <p className="text-(--muted) text-xs font-bold">
              GoalLine Turf is a premium 5-a-side football <br /> turf located
              in a secure environment with top <br /> facilities. Whether
              it&apos;s a friendly match <br /> or regular training, we&apos;ve
              got you covered.
            </p>
